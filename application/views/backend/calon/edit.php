        ...
        <div class="card-body"><h5 class="card-title">Form Edit Data Calon</h5>
          ...
          <?php if ($this->session->userdata('status_users')=="ADMIN") {?>
              ...
              <div class="col-md-6">
               ...
               <div class="form-row">
              <div class="col-md-6">
                <div class="position-relative form-group"><label for="id_user" class="">Petugas</label>
                  <select name="id_user" class="form-control">
                    <?php foreach ($petugas as $p): ?>
                      <?php $selected = ($r->id_user == $p->id_user)?"selected":"" ?>
                      <option value="<?php echo $p->id_user ?>" <?php echo $selected ?>><?php echo $p->nama ?></option>s
                    <?php endforeach ?>
                  </select>
                </div>
              </div>
